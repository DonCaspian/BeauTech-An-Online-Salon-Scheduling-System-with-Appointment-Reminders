  ...
  <div class="navbar-collapse">
    <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      <ul class="nav" id="side-menu">
        ...
        <li>
          <a href="readenq.php"><i class="fa fa-envelope-o nav_icon"></i>Enquiry<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level collapse">
            <li>
        ...
        <li>
          <a href="logout.php" class="chart-nav"><i class="fa fa-sign-out nav_icon"></i>Logout</a>
        </li>
      </ul>
