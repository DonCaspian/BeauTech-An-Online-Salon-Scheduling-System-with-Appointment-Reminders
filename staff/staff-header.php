<div class="sticky-header header-section ">
  ...
  <div class="header-right">
    ...
    <?php
    $staffid=$_SESSION['bpmsaid'];
    $ret=mysqli_query($con,"select AdminName from tblAdStaff where ID='$staffid'");
        ...
        <li class="dropdown profile_details_drop">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
            <div class="profile_img"> 
              <span class="prfil-img"><img src="images/staff.png" alt="" width="50" height="50"> </span> 
              <div class="user-name">
                <p><?php echo $name; ?></p>
                <span>Staff</span>
              </div>
          ...
          <ul class="dropdown-menu drp-mnu">
            ...
            <li> <a href="staff-profile.php"><i class="fa fa-user"></i> My Profile</a> </li> 
