...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputPassword1">Request Type:</label><input type="radio" name="requesttype" value="mtwise" checked="true"> Monthly
                  <input type="radio" name="requesttype" value="yrwise">Yearly </div>
